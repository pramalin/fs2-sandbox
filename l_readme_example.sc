object l_readme_example {
	...
	*/
	...
	implicit val cs: ContextShift[IO] = IO.contextShift(scala.concurrent.ExecutionContext.Implicits.global)
                                                  //> cs  : cats.effect.ContextShift[cats.effect.IO] = cats.effect.internals.IOCo
                                                  //| ntextShift@5ae9a829
	...
	val blockingExecutionContext = ExecutionContext.fromExecutorService(Executors.newFixedThreadPool(2))
                                                  //> blockingExecutionContext  : scala.concurrent.ExecutionContextExecutorServic
                                                  //| e = scala.concurrent.impl.ExecutionContextImpl$$anon$1@643b1d11
	...
	*/
	val task: IO[Unit] = written.compile.drain//> task  : cats.effect.IO[Unit] = <function1>
	/*
